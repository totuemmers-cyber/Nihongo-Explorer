...
const mappings={
  'lesson-44':['n3-zaruwoenai','n4-wake-ni-ikanai'], 'lesson-45':['n3-kaneru','n3-kanenai'],
  'lesson-46':['n2-ni-hoka-naranai','n3-ni-suginai'], 'lesson-47':['n1-tari-tomo-nai','n1-sura','n1-dani'],
  ...
  'lesson-54':['n1-te-yamanai','n1-ni-taenai','n1-ni-katakunai'], 'lesson-55':['n1-ta-ga-saigo','n1-ya-inaya','n1-nari'],
