...
(function () {
  ...
  function storeSession(state) {
    window.NihongoStorage.session.setItem('nihongo-workspace', JSON.stringify(state));
  }
  ...
  var session = null;
  try { session = JSON.parse(window.NihongoStorage.session.getItem('nihongo-workspace')); } catch (e) { /* Optional session state. */ }
